...
function prizeDoor(door) {
  if (door == 1) {
    alert("You have selected door " + door + " and you won a car");
  } else if (door == 2 ) {
    alert("You have selected door " + door + " and you won a boat");
  } else if (door == 3) {
    alert("You have selected door " + door + " and you won a millon dollars");
  } else {
    alert("Door number " + door + " is invalid");
  }
};
